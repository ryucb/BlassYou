...
<script>
	...
	function emailPush(){
		let seIndex = $(event.target.parentElement.parentElement.children[5].children).val();
		let userId = $(event.target.parentElement.parentElement.children[2]).text();
		let userName = $(event.target.parentElement.parentElement.children[3]).text();
		console.log(userId);
